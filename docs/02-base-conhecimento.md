...
O exemplo abaixo se baseia nos dados originais da base de conhecimento, mas os sintetiza deixando apenas as informações mais relevantes, otimizando assim o consumo de tokens. Entretanto, vale lembrar que mais importante do que economizar tokens, é ter todas as informações relevantes disponíveis em seu contexto.
...
- Saldo disponível: R$ 5.000 (meta de R$ 15.000)
...
- Saúde : R$ 188
- Lazer : R$ 55,90
- Total de saídas : R$ 2.583,90

Produtos Disponíveis para Explicar:
- Tesouru Selic (risco baixo)
